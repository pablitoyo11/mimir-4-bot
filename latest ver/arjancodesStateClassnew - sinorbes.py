...
import time
import random
from SSCompare_tmp_ref import respawn_check, automove_check, openingchest_check, map_check, collectingvoidorb_check
...
class ReturningToMapState:
    ...
    def execute(self):
        ...
        print(mapcheck)
        if mapcheck == "map_on":
            print("Map is on, returning to previous state")
            self.bot.state = self.bot.previous_state  # Volver al estado anterior
...
class RespawningState:
    ...
    def execute(self):
        ...
        self.bot.state = ReturningToMapState(self.bot, self.actions_file, self.window_title)
...
class OpeningChestState:
    ...
    def execute(self):
        ...
        try:
            ...
            chest_status = openingchest_check(self.window_title)
    ...
    def execute(self):
        ...
        try:
            ...
            if respawnCheck == "respawn_on":
                ...
                self.state = RespawningState(self, self.actions_file, self.window_title)  # Pasar actions_file y window_title
            ...
            try:
                ...
                if mapCheck == "map_off":
                    ...
                    if elapsed_time >= 20:
                        ...
                        self.previous_state = self.state
                        self.state = ReturningToMapState(self, self.actions_file, self.window_title)  # Cambiar estado a ReturningToMapState
                        return  # Exit the method to cancel subsequent execution
                    else:
