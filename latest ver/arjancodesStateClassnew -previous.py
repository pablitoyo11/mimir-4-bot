...
from CreateNLoadSecuencias import interprete_de_accion
...
class RespawningState:
    def __init__(self, bot, actions_file):
        self.bot = bot
    ...
    def execute(self):
        ...
        map_check(self.actions_file,self.window_title)  # Llamar a map_check
...
class AutoMoveState:
    def __init__(self, bot, actions_file, window_title):
        ...
        self.max_check_time = random.randint(2, 3)  # Random duration between 2 and 3 seconds
        self.previous_action = None  # Initialize previous_action
        sleep(3) # wait 3 seconds to start
    ...
    def execute(self):
        ...
        try:
            ...
            if respawnCheck == "respawn_on":
                ...
                self.state = RespawningState(self, self.actions_file)  # Pasar actions_file
...
def main():
    ...
    actions_file = "secuencias/EliteBicheonCastleBackstreet.pkl"
