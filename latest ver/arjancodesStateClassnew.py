...
class AutoMoveState:
    def __init__(self, bot, actions_file, window_title):
        ...
        line_count = len(self.actions)#contar lineas 
    ...
    def execute(self):
        ...
        try:
            ...
            if automoveCheck == "automove_on":
                ...
                if self.previous_action in ["OpeningChestHandler", "RecolectingVoidOrbHandler"]:
...
##    actions_file = "EliteBicheonCastleBackstreet.pkl"
    actions_file = "MirageShipInnerCabins.pkl"
